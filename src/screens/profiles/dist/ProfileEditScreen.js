...
var ProfileEditScreen = function () {
    ...
    var _d = react_1.useState(''), age = _d[0], setAge = _d[1];
    var _e = react_1.useState(''), height = _e[0], setHeight = _e[1];
    var _f = react_1.useState(''), weight = _f[0], setWeight = _f[1];
    ...
    return (react_1["default"].createElement(react_native_1.View, null,
        ...
        react_1["default"].createElement(react_native_1.TextInput, { placeholder: "Age", value: age, onChangeText: setAge }),
        react_1["default"].createElement(react_native_1.TextInput, { placeholder: "Height", value: height, onChangeText: setHeight }),
        react_1["default"].createElement(react_native_1.TextInput, { placeholder: "Weight", value: weight, onChangeText: setWeight }),
        react_1["default"].createElement(react_native_1.TextInput, { placeholder: "Blood Type", value: bloodType, onChangeText: setBloodType }),
