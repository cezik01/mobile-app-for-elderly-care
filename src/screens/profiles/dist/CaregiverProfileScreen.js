...
var CaregiverProfileScreen = function () {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.screenContainer },
        react_1["default"].createElement(ProfileHeader_1["default"], { name: "Caregiver Name", city: "City Name", onEditPress: handleEditPress, onNotificationsPress: handleNotificationsPress, onMenuPress: handleMenuPress }),
