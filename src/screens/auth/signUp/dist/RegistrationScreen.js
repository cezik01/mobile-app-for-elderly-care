...
var i18n_1 = require("common/i18n/i18n");
var RegistrationScreen = function (_a) {
    var navigation = _a.navigation;
    var _b = react_2.useState('patient'), role = _b[0], setRole = _b[1];
    var _c = react_2.useState(false), visible = _c[0], setVisible = _c[1];
    ...
    return (react_1["default"].createElement(AuthForm_1["default"], { onSubmit: handleRegistration, buttonTitle: "SignUp" },
        react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].pickerContainer },
            react_1["default"].createElement(react_native_paper_1.Menu, { visible: visible, onDismiss: closeMenu, anchor: react_1["default"].createElement(react_native_paper_1.Button, { mode: "outlined", onPress: openMenu }, role ? role : i18n_1["default"].t('SelectYourRole')) },
                react_1["default"].createElement(react_native_paper_1.Menu.Item, { onPress: function () { setRole('Patient'); closeMenu(); }, title: i18n_1["default"].t('Patient') }),
                react_1["default"].createElement(react_native_paper_1.Menu.Item, { onPress: function () { setRole('Caregiver'); closeMenu(); }, title: i18n_1["default"].t('Caregiver') }))),
        react_1["default"].createElement(react_native_1.TouchableOpacity, { onPress: function () { return navigation.navigate('Login'); } },
            react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].linkText }, i18n_1["default"].t('HaveAccountLogin')))));
};
