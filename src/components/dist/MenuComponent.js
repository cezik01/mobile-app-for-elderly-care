...
var MenuComponent = function (_a) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.menuContainer },
        react_1["default"].createElement(MenuItem, { onPress: onMedicationPress, iconName: require('../../assets/profiles/medicationIcon.png'), text: "Medication" }),
        react_1["default"].createElement(MenuItem, { onPress: onAppointmentsPress, iconName: require('../../assets/profiles/appointmentsIcon.png'), text: "Appointments" })));
};
