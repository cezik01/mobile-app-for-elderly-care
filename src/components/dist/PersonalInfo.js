...
var PersonalInfo = function (_a) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.container },
        react_1["default"].createElement(PersonalInfoItem, { icon: require('../../assets/profiles/Age.png'), label: "Age: " + age }),
        react_1["default"].createElement(react_native_1.View, { style: styles.divider }),
        react_1["default"].createElement(PersonalInfoItem, { icon: require('../../assets/profiles/Weight.png'), label: "Weight: " + weight }),
        react_1["default"].createElement(react_native_1.View, { style: styles.divider }),
        react_1["default"].createElement(PersonalInfoItem, { icon: require('../../assets/profiles/Height.png'), label: "Height: " + height }),
        react_1["default"].createElement(react_native_1.View, { style: styles.divider }),
        react_1["default"].createElement(PersonalInfoItem, { icon: require('../../assets/profiles/BloodType.png'), label: "Blood Type: " + bloodType })));
};
