...
var HealthMetrics = function (_a) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.metricsContainer },
        react_1["default"].createElement(HealthMetricItem, { icon: require('../../../assets/profiles/Graph.png'), label: "Blood Pressure", value: bloodPressure, color: getHealthMetricColor(bloodPressure) }),
        react_1["default"].createElement(HealthMetricItem, { icon: require('../../../assets/profiles/Group.png'), label: "Blood Sugar", value: bloodSugar, color: getHealthMetricColor(bloodSugar) })));
};
